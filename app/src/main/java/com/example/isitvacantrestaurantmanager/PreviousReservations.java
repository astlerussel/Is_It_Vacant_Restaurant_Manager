 ...
 */
public class PreviousReservations extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_previous_reservations, container, false);
        ...
        contactsRef = db.collection("/restaurants/"+uid+"/previous_reservations");
        query = contactsRef;
